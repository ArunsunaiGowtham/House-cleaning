...
<section class="section">
  <div class="container">
    <div class="row g-3 align-items-center mb-4">
      <div class="col-lg-5">
        ...
        <div class="input-group position-relative">
          ...
          <input class="form-control border-start-0 pe-5" type="search" id="serviceSearch" placeholder="Search services, e.g. carpet" data-iso-search autocomplete="off">
    ...
    <div class="row g-4 g-xl-5" id="servicesGrid" data-isotope><div class="col-md-6 col-xl-4 iso-item home" data-service-name="residential-cleaning" data-service-label="Residential Cleaning"><article class="service-card h-100" data-aos="fade-up" data-aos-delay="0">
